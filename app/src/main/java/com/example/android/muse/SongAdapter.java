...
public class SongAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView title_text_view = listItemView.findViewById(R.id.title_text_view);
        ...
        TextView artist_text_view = listItemView.findViewById(R.id.artist_text_view);
        ...
        ImageView song_image_view = listItemView.findViewById(R.id.song_image_view);
